...
public class FoodPositiveDrugTest extends ItemFood implements IHasModel {
	public FoodPositiveDrugTest(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase player) {
		if(!worldIn.isRemote) {
			PositiveDrugTest.addEffect(player);
		}
