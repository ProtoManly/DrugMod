...
public class FoodCannabis_Pill extends ItemFood implements IHasModel {
	public FoodCannabis_Pill(String name, int amount, float saturation, boolean isWolfFood) {
